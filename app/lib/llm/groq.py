...
class GroqLLMProvider(LLMProvider):
    ...
    async def chat_completion_stream(
        ...
        logger.info(f"GroqLLMProvider.chat_completion_stream called with model: {self.model_name}")
    ...
    async def chat_completion(
        ...
        last_error: Any = None
        logger.info(f"GroqLLMProvider.chat_completion called with model: {self.model_name}")
        for attempt in range((retry or 0) + 1):
