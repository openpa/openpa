...
class OpenAILLMProvider(LLMProvider):
    ...
    async def chat_completion_stream(
        ...
        last_error: Any = None
        logger.info(f"OpenAILLMProvider.chat_completion_stream called with model: {self.model_name}")
    ...
    async def chat_completion(
        ...
        last_error: Any = None
        logger.info(f"OpenAILLMProvider.chat_completion called with model: {self.model_name}")
        for attempt in range((retry or 0) + 1):
